            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="h-full">
                  <Card className="bg-bg-light border-border shadow-s hover:shadow-m transition-shadow h-full">
                    <CardContent className="p-6">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-full bg-bg border border-border text-primary flex items-center justify-center font-semibold">
