...
export function FAQ() {
  return (
    <section id="faq" className="py-16 sm:py-24 bg-bg-dark">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-muted">
            Everything you need to know about Owen.
          </p>
        </div>

        <div className="bg-bg-light rounded-xl border border-border shadow-s px-6">
          {faqs.map((faq, index) => (
